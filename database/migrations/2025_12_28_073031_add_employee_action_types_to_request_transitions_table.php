...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        Schema::create('request_transitions', function (Blueprint $table) {
            ...
            $table->enum('action', [
                ...
                'reject_idea',
                'activate',
                'employee_accept',      // New: Employee accepts/starts work
                'employee_reject',      // New: Employee rejects request
                'employee_complete',    // New: Employee completes request
                'progress_update'       // New: Employee updates progress
            ]);
    ...
    public function down(): void
    {
        ...
        foreach ($transitions as $transition) {
            if (!in_array($transition->action, ['employee_accept', 'employee_reject', 'employee_complete', 'progress_update'])) {
                DB::table('request_transitions')->insert((array) $transition);
            }
        }
    }
